        ...
        while (fgets(line, sizeof(line), f)) {
                ...
                if (line[0]=='M') {
                                ...
                                &dmac[3], &dmac[4], &dmac[5]) )
                    {
                        fputs(line, stderr);
                        printf("\n");
                        printf("%c %hhd %hhd %hhx:%hhx:%hhx:%hhx:%hhx:%hhx %hhx:%hhx:%hhx:%hhx:%hhx:%hhx",dummy, nhgrp, port, smac[0], smac[1], smac[2], smac[3], smac[4], smac[5],dmac[0], dmac[1], dmac[2], dmac[3], dmac[4], dmac[5]);
